...
char H5libhdf5_settings[]=
	...
	"             Installation point: /data/data/com.vmos.pro/osimg/r/ot01/data/data/com.termux/files/usr\n"
	"\n"
	"Compiling Options:\n"
	"------------------\n"
	"                     Build Mode: Release\n"
	...
	"                        LDFLAGS: -Wl,--as-needed -L/data/data/com.vmos.pro/osimg/r/ot01/data/data/com.termux/files/usr/lib\n"
	"                     H5_LDFLAGS: \n"
	"                     AM_LDFLAGS: \n"
	"                Extra libraries: m;dl\n"
	"                       Archiver: /data/data/com.vmos.pro/osimg/r/ot01/data/data/com.termux/files/usr/bin/ar\n"
	"                         Ranlib: /data/data/com.vmos.pro/osimg/r/ot01/data/data/com.termux/files/usr/bin/ranlib\n"
	"\n"
	"Languages:\n"
	"----------\n"
	"                              C: YES\n"
	"                     C Compiler: /data/data/com.vmos.pro/osimg/r/ot01/data/data/com.termux/files/usr/bin/clang 15.0.3\n"
	"                       CPPFLAGS: \n"
	"                    H5_CPPFLAGS: \n"
	"                    AM_CPPFLAGS: \n"
	"                         CFLAGS:  -std=c99 -Oz -fstack-protector-strong -I/data/data/com.vmos.pro/osimg/r/ot01/data/data/com.termux/files/usr/include\n"
	...
	"                            C++: ON\n"
	"                   C++ Compiler: /data/data/com.vmos.pro/osimg/r/ot01/data/data/com.termux/files/usr/bin/clang++ 15.0.3\n"
	"                      C++ Flags:  -Oz -fstack-protector-strong -I/data/data/com.vmos.pro/osimg/r/ot01/data/data/com.termux/files/usr/include\n"
